...
urlpatterns = [
    ...
    path('admin-take-attendance/<str:level>', views.admin_take_attendance_view, name='admin-take-attendance'),
    path('admin-view-attendance/<str:level>', views.admin_view_attendance_view, name='admin-view-attendance'),
    path('admin-fee', views.admin_fee_view, name='admin-fee'),
    path('admin-view-fee/<str:level>', views.admin_view_fee_view, name='admin-view-fee'),
    ...
    path('teacher-take-attendance/<str:level>', views.teacher_take_attendance_view, name='teacher-take-attendance'),
    path('teacher-view-attendance/<str:level>', views.teacher_view_attendance_view, name='teacher-view-attendance'),
